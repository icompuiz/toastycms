...
<?php echo $this->Form->create('MediaDirectory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Media Directory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MediaDirectory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MediaDirectory.id'))); ?></li>
