...
<?php echo $this->Form->create('UserPropertySkel'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Property Skel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserPropertySkel.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserPropertySkel.id'))); ?></li>
