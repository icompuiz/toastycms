...
<?php echo $this->Form->create('ContentTemplate'); ?>
	<fieldset>
		<legend><?php echo __('Edit Content Template'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ContentTemplate.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ContentTemplate.id'))); ?></li>
