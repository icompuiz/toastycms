...
<div id="content-template-controls" class="btn-toolbar pull-right controls">
    <div class="btn-group">
        ...
        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ContentTemplate.id'), 'management' => true), array('class' => 'btn'), __('Are you sure you want to delete # %s?', $this->Form->value('ContentTemplate.id'))); ?>
...
<div id="add-content-template-navigator" class="navigator content-navigator tabbable"> <!-- Only required for left/right tabs -->
    <ul class="nav nav-tabs">
        <li class="active"><a href="#content-template-settings-tab" data-toggle="tab">Settings</a></li>
    </ul>
    <?php
    echo $this->Form->create('ToastyCore.ContentTemplate', array(
        'url' => array('controller' => 'content_templates', 'action' => 'edit', $this->Form->value('ContentTemplate.id'), 'management' => true),
        ...
        <div class="tab-pane active well" id="content-template-settings-tab">
            ...
            <ul>
                <li>
                    <div class="input">
                        <?php
                        echo $this->Form->input('ContentTemplate.id');
                        echo $this->Form->hidden('ContentTemplate.original_path', array(
                            'value' => $this->Form->value('ContentTemplate.system_path')
                                )
                        );
...
//echo $this->Html->script('ToastyCore.code_behind/content_template');
