...
<?php echo $this->Form->create('UserProperty'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Property'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserProperty.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserProperty.id'))); ?></li>
